...
//---------------------------------------------------------
            ...
            {
        //        var ei = Mapper.GetExceptionInfo(ex, "when");
       //         var ei = Mapper.GetExceptionInfo(new Exception("InvaliArgumentException"), "when");
 ...
 //---------------------------------------------------------
            ...
            {
         //       var ei = Mapper.GetExceptionInfo(ex, "then");
        //       var ei = Mapper.GetExceptionInfo(new Exception("InvaliArgumentException"), "then");
...
//---------------------------------------------------------
            ...
            {
        //      var ei = Mapper.GetExceptionInfo(ex, "given");
          //     var ei = Mapper.GetExceptionInfo(new Exception("InvaliArgumentException"), "given");
...
//---------------------------------------------------------
         ...
         //       var ei = Mapper.GetExceptionInfo(ex, "ggg");
            ...
            Console.ReadKey();
            //   var v = mp.GetExceptionInfo(new Exception("fds"),"gi");
        }
